...
function assignKey(to, from, key) {
  ...
  if (isDef(val)) {
    if (!Object.prototype.hasOwnProperty.call(to, key) || !utils_isObject(val)) {
      to[key] = val;
    } else {
  ...
  Object(createClass["a" /* default */])(VgDate, [{
    ...
    value: function init(year, month, date) {
      if (year instanceof VgDate) {
        ...
        this.init.apply(this, _toConsumableArray(year.split("-")));
      } else {
        if (year && month && date) {
    ...
    value: function highLightDefault() {
      if (this.mode === "double") {
        ...
        if (this.doubleModeAllowSameDate && startNode.key === endNode.key) {
          ...
          setProperty(endNode, "mark", "".concat(this.fromDateMark, "-").concat(this.toDateMark));
        }
        ...
        if (!this.toDate) {
          if (date.key === this.fromDate.key) {
            if (this.doubleModeAllowSameDate) {
              ...
              setProperty(date, "mark", "".concat(this.fromDateMark, "-").concat(this.toDateMark));
            ...
            if (this.fromDate.vgDate.isAfter(date.vgDate)) {
              if (this.crossed) {
                ...
                push(this.changedNode[this.fromDate.key].className, "end");
                setProperty(this.changedNode[this.fromDate.key], "mark", this.toDateMark);
    ...
    value: function generateDate() {
      ...
      caculatedMonth.forEach(function (item) {
        ...
        for (var i = 1; i <= daysOfMonth; i++) {
          ...
          push(className, vg_date_VgDate().isAfter(year, month, j) ? "disable" : "clickable");

          if (_this4.mode === "double" && _this4.fromDate && _this4.toDate) {
            push(className, vg_date_VgDate(year, month, j).isBetween(_this4.fromDate.vgDate, _this4.toDate.vgDate) ? "during-active" : "");
          }
              ...
              default: function _default() {
                ...
                monthItem.dates.forEach(function (date) {
                  ...
                  dateDom.push(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])(src_flex_item, {
                    key: date.key,
                    class: ["vg-calendar-date"].concat(_toConsumableArray(date.className)),
                    ref: ref,
...
// CONCATENATED MODULE: ./src/utils/event/index.ts
/*
* @Author: Just be free
...
try {
  ...
  window.addEventListener("test", function () {}, event_options);
} catch (err) {}
...
var citypicker_VgCitypicker = /*#__PURE__*/function (_mixins) {
  ...
  Object(createClass["a" /* default */])(VgCitypicker, [{
          ...
          default: function _default() {
            return Array.apply(null, cities).map(function (city, key) {
              return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])(src_flex_item, {
                ...
                class: ["city-item", "column-".concat(_this3.column)].concat(_toConsumableArray(_this3.textOverflow(_this3.parse(city))))
              }, {
                default: function _default() {
                  return [Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("span", {}, {
                    default: function _default() {
    ...
    value: function createBodyArea() {
      var body = [];
      body.push.apply(body, _toConsumableArray(this.createHistoryArea()));
      body.push.apply(body, _toConsumableArray(this.createHotCityArea()));
      body.push.apply(body, _toConsumableArray(this.createAlphaBeta()));
    ...
    value: function creteHeaderArea() {
      ...
      header.push.apply(header, _toConsumableArray(this.creteInputSearchArea()));
      return header;
    }
  }, {
...
var slider_VgSlider = /*#__PURE__*/function (_mixins) {
  ...
  Object(createClass["a" /* default */])(VgSlider, [{
    ...
    value: function genSider(type) {
      ...
      if (type === "start") {
        if (!utils_isObject(this.modelValue)) {
          return [];
        }
      }
      ...
      var tipValueSize = getCharLength(String(tipValue)) * 7;
      ...
      this.bindEvent(this.$el, {
        stop: function stop(event) {
          ...
          if (event.e && event.e.changedTouches && event.e.changedTouches[0]) {
            ...
            if (utils_isObject(that.modelValue)) {
  ...
  Object(createClass["a" /* default */])(VgPickyStepper, [{
    ...
    value: function createHeader() {
      ...
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("div", {
        ...
        default: function _default() {
          return [].concat(_toConsumableArray(_this3.createBack()), [_this3.createTitle(), _this3.createClose()]);
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("div", {
        ...
        default: function _default() {
          return [_this9.createHeader()].concat(_toConsumableArray(_this9.createSteps()), [_this9.createFooter()]);
        }
      }), [[external_commonjs_vue_commonjs2_vue_root_Vue_["vShow"], this.modelValue]])]);
    }
  }]);
        ...
        default: function _default() {
          return [Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("div", {
            ...
            default: function _default() {
              ...
              })].concat(_toConsumableArray(Array.apply(null, new Array(rows)).map(function (row, index, arr) {
                return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("div", {
...
function isOptionDisabled(column) {
  return utils_isObject(column) && column.disabled;
}
        ...
        default: function _default() {
          return [Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("ul", {
            ...
            return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])("li", {
              ...
              default: function _default() {
                return utils_isObject(column) ? column.value : column;
              }
            });
          }))];
        }
