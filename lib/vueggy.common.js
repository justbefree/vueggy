...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ VueGgy_VueGgy; });
__webpack_require__.d(__webpack_exports__, "b", function() { return /* reexport */ mixins; });
__webpack_require__.d(__webpack_exports__, "c", function() { return /* reexport */ vue_class_component_esm_bundler_props; });

// UNUSED EXPORTS: Vue, emits, createDecorator, setup, Options
...
module.exports = JSON.parse("{\"name\":\"vueggy\",\"version\":\"0.2.0\",\"private\":false,\"scripts\":{\"build:components\":\"vue-cli-service build --mode production --target lib --name vueggy --dest lib src/index.ts\",\"serve\":\"vue-cli-service serve\",\"build\":\"vue-cli-service build\",\"lint\":\"vue-cli-service lint\"},\"dependencies\":{\"core-js\":\"^3.6.5\",\"vue\":\"^3.0.0-0\",\"vue-class-component\":\"^8.0.0-0\",\"vue-router\":\"^4.0.0-beta.11\"},\"devDependencies\":{\"@typescript-eslint/eslint-plugin\":\"^2.33.0\",\"@typescript-eslint/parser\":\"^2.33.0\",\"@vue/cli-plugin-babel\":\"~4.5.0\",\"@vue/cli-plugin-eslint\":\"~4.5.0\",\"@vue/cli-plugin-typescript\":\"^4.5.6\",\"@vue/cli-service\":\"~4.5.0\",\"@vue/compiler-sfc\":\"^3.0.0-0\",\"@vue/eslint-config-typescript\":\"^5.0.2\",\"babel-eslint\":\"^10.1.0\",\"eslint\":\"^6.7.2\",\"eslint-plugin-vue\":\"^7.0.0-0\",\"sass\":\"^1.26.11\",\"sass-loader\":\"^10.0.2\",\"typescript\":\"~3.9.3\"},\"typings\":\"types/index.d.ts\",\"files\":[\"lib\"],\"eslintConfig\":{\"root\":true,\"env\":{\"node\":true},\"extends\":[\"plugin:vue/vue3-essential\",\"eslint:recommended\",\"@vue/typescript\"],\"parserOptions\":{\"parser\":\"@typescript-eslint/parser\"},\"rules\":{}},\"browserslist\":[\"> 1%\",\"last 2 versions\",\"not dead\"],\"homepage\":\"https://github.com/justbefree/vueggy#readme\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/justbefree/vueggy.git\"},\"bugs\":{\"url\":\"https://github.com/justbefree/vueggy/issues\"}}");
...
var Props = Object(_component_VueGgy__WEBPACK_IMPORTED_MODULE_5__[/* props */ "c"])({
  color: String,
  size: Number
});
...
var Rotate = /*#__PURE__*/function (_mixins) {
  ...
  return Rotate;
}(Object(_component_VueGgy__WEBPACK_IMPORTED_MODULE_5__[/* mixins */ "b"])(_component_VueGgy__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], Props));
...
var Props = Object(VueGgy["c" /* props */])({
...
var flex_VgFlex = /*#__PURE__*/function (_mixins) {
  ...
  return VgFlex;
}(Object(VueGgy["b" /* mixins */])(VueGgy["a" /* default */], Props));
...
var flex_item_Props = Object(VueGgy["c" /* props */])({
  alignSelf: {
    type: String,
    default: "auto"
  },
...
var flex_item_VgFlexItem = /*#__PURE__*/function (_mixins) {
  ...
  return VgFlexItem;
}(Object(VueGgy["b" /* mixins */])(VueGgy["a" /* default */], flex_item_Props));
...
var toast_VgToast = /*#__PURE__*/function (_VueGgy) {
  Object(inherits["a" /* default */])(VgToast, _VueGgy);
  ...
  Object(createClass["a" /* default */])(VgToast, [{
    ...
    value: function setPosition() {
      ...
      var validPosition = ["bottom", "middle", "top"];
    ...
    value: function render() {
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])(external_commonjs_vue_commonjs2_vue_root_Vue_["Transition"], {
        ...
        class: "toast-text"
      }, [this.message])]), [[external_commonjs_vue_commonjs2_vue_root_Vue_["vShow"], this.visible]])]);
    }
  }]);
...
function renderDOM(component, props, children) {
  ...
  console.log("renderDOM ", vnode, Object(external_commonjs_vue_commonjs2_vue_root_Vue_["render"])(vnode, dom));
...
var toast_getInstance = function getInstance() {
  ...
  return renderDOM(toast_VgToast, {}, []);
};
...
var spin_Props = Object(VueGgy["c" /* props */])({
  type: {
    type: String,
    default: "snake"
  },
...
var spin_VgSpin = /*#__PURE__*/function (_mixins) {
  ...
  return VgSpin;
}(Object(VueGgy["b" /* mixins */])(VueGgy["a" /* default */], spin_Props));
...
var VALIDATE_POSITION_VALUE = ["left", "right", "top", "bottom", "middle"]; // import PopupManager from "../component/popupManager.js";



var idSeed = 1;

var closeIcon = __webpack_require__("29ce");

var popup_Props = Object(VueGgy["c" /* props */])({
  modelValue: {
    type: Boolean,
    default: false
  },
  ...
  Object(createClass["a" /* default */])(VgPopup, [{
    ...
    value: function render() {
      ...
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])(external_commonjs_vue_commonjs2_vue_root_Vue_["Transition"], {
        ...
        style: _objectSpread2({}, this.genStyle(position))
      }, [this.createCloseIcon(), slots]), [[external_commonjs_vue_commonjs2_vue_root_Vue_["vShow"], this.modelValue]])]);
    }
  }]);

  return VgPopup;
}(Object(VueGgy["b" /* mixins */])(VueGgy["a" /* default */], popup_Props));
...
var components = [flex, flex_item, toast, spin, popup];
