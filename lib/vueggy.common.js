...
var animation_list_VgAnimationList = (animation_list_temp = animation_list_class = /*#__PURE__*/function (_mixins$with) {
  ...
  Object(createClass["a" /* default */])(VgAnimationList, [{
    ...
    value: function handleEnter(el, done) {
      ...
      var delay = Number(el.getAttribute("dataindex")) * 100;
      setTimeout(function () {
